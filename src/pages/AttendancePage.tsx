        ...
        <div className="space-y-4">
          {subjects.map((subject, index) => (
            <button
              ...
              className="w-full bg-gray-800/50 rounded-2xl p-4 flex items-center gap-4 hover:bg-gray-800/70 transition-colors"
            >
              <div className={`w-12 h-12 rounded-full ${subject.color}`}></div>
